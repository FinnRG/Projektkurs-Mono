...
use crate::rpc::register_response::Type;
...
pub fn create_user(name: &str, email: &str, password: &str) -> Result<String, Type> {
    ...
    diesel::insert_into(users::table)
        ...
        .map_err(|err| {
            match err {
                Error::DatabaseError(DatabaseErrorKind::UniqueViolation, _) => Type::Uniqueviolation,
                _ => Type::Other,
            }
        })
        .map(|_| id.to_string())
