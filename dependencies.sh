...
helm upgrade --install postgres-users --set auth.postgresPassword=strongPassword,auth.database=projekt,primary.persistence.enabled=false bitnami/postgresql
